...
import 'package:otk_wms_mock/archive/pickking5.dart';

import '../l10n/app_localizations.dart';

class PickkingStart3Screen extends StatefulWidget {
  final int currentStep;

  const PickkingStart3Screen({super.key, this.currentStep = 1});

  @override
  State<PickkingStart3Screen> createState() => _PickkingStart3ScreenState();
}

class _PickkingStart3ScreenState extends State<PickkingStart3Screen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await _audioPlayer.play(AssetSource('sounds/pic-start2.ogg'));
  ...
  void _onImageTapped() async {
    ...
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => const Pickking5Screen(),
              ...
              style: TextStyle(fontSize: 14),
                    ...
                    body: Column(
                      children: [
                        ...
                        Text(
                          AppLocalizations.of(context)!.empty_pallet(1),
                          style: TextStyle(
                            fontSize: 25,
                            fontFamily: 'Helvetica Neue',
                            fontWeight: FontWeight.bold,
