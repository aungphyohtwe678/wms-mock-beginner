...
class Pickking7Screen extends StatefulWidget {
  ...
  const Pickking7Screen({super.key, this.currentStep = 1});

  @override
  State<Pickking7Screen> createState() => _Pickking7ScreenState();
}

class _Pickking7ScreenState extends State<Pickking7Screen> {
