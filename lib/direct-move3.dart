...
class DirectMove3Screen extends StatefulWidget {
  final int currentStep;

  const DirectMove3Screen({super.key, this.currentStep = 1});

  @override
  State<DirectMove3Screen> createState() => _DirectMove3ScreenState();
}

class _DirectMove3ScreenState extends State<DirectMove3Screen> {
