...
class KinkyuSakiCS3Screen extends StatefulWidget {
  ...
  const KinkyuSakiCS3Screen({super.key, this.currentStep = 1});

  @override
  State<KinkyuSakiCS3Screen> createState() => _KinkyuSakiCS3ScreenState();
}

class _KinkyuSakiCS3ScreenState extends State<KinkyuSakiCS3Screen> {
...
//         Text('・商品バーコードをスキャン'),
//         Text('・「出力されたラベルを商品に貼り付けてください」音声'),
//         Text('・「{格納ロケーション}に移動し、ロケーションをスキャンしてください」音声'),
//         Text('・格納ロケーションのバーコードをスキャン'),
//         Text('・「緊急補充完了」音声'),
//         Text('・メニューへ戻る'),
//         SizedBox(height: 8),
//         Text(
