...
class DirectMove2Screen extends StatefulWidget {
  final int currentStep;

  const DirectMove2Screen({super.key, this.currentStep = 1});

  @override
  State<DirectMove2Screen> createState() => _DirectMove2ScreenState();
}

class _DirectMove2ScreenState extends State<DirectMove2Screen> {
  ...
  Future<void> _playStepSound(int stepIndex) async {
    final soundMap = {
      ...
      4: 'sounds/aki-loc.ogg', 
      5: 'sounds/ido-kanryo.ogg',
    };
