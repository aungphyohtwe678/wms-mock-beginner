...
class KinkyuMotoC2Screen extends StatefulWidget {
  ...
  const KinkyuMotoC2Screen({super.key, this.currentStep = 1});

  @override
  State<KinkyuMotoC2Screen> createState() => _KinkyuMotoC2ScreenState();
}

class _KinkyuMotoC2ScreenState extends State<KinkyuMotoC2Screen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await _audioPlayer.play(AssetSource('sounds/hozyu-kara.ogg'));
